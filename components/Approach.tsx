...
const AceternityIcon = ({order} :{order:string}) => {
    ...
    <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2 pad text-2xl font-bold text-white backdrop-blur-3xl">
        {order}
    </span>
        </button>
    </div>
